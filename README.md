...
**Stat Priority First** is a focused guide addon for Midnight (12.1, Season 2). It puts Wowhead-sourced **stat priority chains**, **BiS gear picks**, and a friendly **diminishing returns** walkthrough in a small floating panel, plus a compact priority strip above your Character frame.
...
Left-click the **minimap button** to open the panel, and right-click jumps to your current spec. Drag the button around the minimap rim to reposition.
